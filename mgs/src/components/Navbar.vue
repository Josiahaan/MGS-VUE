<template>
<nav x-data="{ isOpen: false }" class="relative bg-white shadow dark:bg-gray-900">
    <div class="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
        <div class="flex items-center justify-between">
            <a href="#">
                <img class="w-auto h-6 sm:h-7" src="https://megagigasolusindo.co.id/wp-content/uploads/2022/04/cropped-Website-Logo.png" alt="">
            </a>
        ...
        <!-- Mobile Menu open: "block", Menu closed: "hidden" -->
          <div class="flex flex-col md:flex-row md:mx-6">
                <p class="my-2 text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400 md:mx-4 md:my-0">MGS MARKETPLACE</p>
            </div>
